...
public class SpecialInfo : MonoBehaviour
{
    public string GetCardInfo(Card card)
    {
        ...
        string text =
            ...
            (card.special.regeneration[card.rank] > 0 ? "<b>" + "Regeneration " + card.special.regeneration[card.rank] + ": " + "</b>" + "Heal yourself each turn" + "\n" : "") +
            ...
            (card.special.poisoned[card.rank] > 0 ? "<b>" + "Poisoned " + card.special.poisoned[card.rank] + ": " + "</b>" + "You take magical damage each turn" + "\n" : "") +
            (card.special.immolate[card.rank] > 0 ? "<b>" + "Immolate " + card.special.immolate[card.rank] + ": " + "</b>" + "You take magical damage each turn" + "\n" : "") +
            ...
            (card.special.soulEater[card.rank] > 0 ? "<b>" + "Soul Eater " + card.special.soulEater[card.rank] + ": " + "</b>" + "Gain +" + card.special.soulEater[card.rank] + "/+" + card.special.soulEater[card.rank] + " whenever you attack the enemy hero" + "\n" : "") +
            ...
            (card.special.spellCursed[card.rank] > 0 ? "<b>" + "Spell Cursed " + card.special.spellCursed[card.rank] + ": " + "</b>" + "You take increased magical damage" + "\n" : "") +
            (card.special.spellFeed[card.rank] > 0 ? "<b>" + "Spell Feed " + card.special.spellFeed[card.rank] + ": " + "</b>" + "Gain +" + card.special.spellFeed[card.rank] + "/+" + card.special.spellFeed[card.rank] + " whenever you take magical damage" + "\n" : "") +
            ...
            (card.special.embered[card.rank] > 0 ? "<b>" + "Embered " + card.special.embered[card.rank] + ": " + "</b>" + "You take magical damage next turn" + "\n" : "") +
            ...
            (card.special.rage[card.rank] > 0 ? "<b>" + "Rage " + card.special.rage[card.rank] + ": " + "</b>" + "Gain attack whenever you take damage" + "\n" : "") +
            (card.special.carnivore[card.rank] > 0 ? "<b>" + "Carnivore " + card.special.carnivore[card.rank] + ": " + "</b>" + "Gain health whenever you kill a unit" + "\n" : "") +
            (card.special.bloodPrice[card.rank] > 0 ? "<b>" + "Blood Price " + card.special.bloodPrice[card.rank] + ": " + "</b>" + "Deal damage to your own hero each turn" + "\n" : "") +
            ...
            (card.special.maimed[card.rank] > 0 ? "<b>" + "Maimed " + card.special.maimed[card.rank] + ": " + "</b>" + "You take increased physical damage" + "\n" : "") +
            (card.special.battleSpirit[card.rank] > 0 ? "<b>" + "Battle Spirit " + card.special.battleSpirit[card.rank] + ": " + "</b>" + "Gain +" + card.special.battleSpirit[card.rank] + "/+" + card.special.battleSpirit[card.rank] + " whenever you take physical damage" + "\n" : "") +
            (card.special.knockback[card.rank] > 0 ? "<b>" + "Knockback " + card.special.knockback[card.rank] + ": " + "</b>" + "Damaged targets will be knocked back " + card.special.knockback + " tiles" + "\n" : "") +
